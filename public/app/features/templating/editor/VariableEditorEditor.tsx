...
export class VariableEditorEditorUnConnected extends PureComponent<Props> {
  ...
  onHandleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (this.props.variable.name !== NEW_VARIABLE_NAME) {
  ...
  render() {
    ...
    const newVariable = this.props.variable.name === NEW_VARIABLE_NAME;
...
const mapStateToProps: MapStateToProps<ConnectedProps, OwnProps, StoreState> = (state, ownProps) => ({
  ...
  variable: getVariable(ownProps.identifier.name, state, false), // we could be renaming a variable and we don't want this to throw
});
